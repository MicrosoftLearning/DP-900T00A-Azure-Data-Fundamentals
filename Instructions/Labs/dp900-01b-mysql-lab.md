...
lab:
  ...
  description: In this lab, you'll provision an Azure Database for MySQL resource from scratch and explore how it's managed in the Azure portal. The lab is written for absolute beginners with no prior Azure or database experience, so every step is explained in plain language.
  duration: 20 minutes
  level: 100
  islab: true
  primarytopics:
...
In this lab, you provisioned an Azure Database for MySQL and explored how it's managed in the Azure portal. You've taken your first steps with open-source relational databases in the cloud!
